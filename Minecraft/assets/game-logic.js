...
// Another Method To Add Score

// let interval = null;
// let playerScore = 0;

// Write this inside startBtn function in 'if e.key' function

// It should be inside 'window.addEventListener('keydown', function (e) { WRITE THE SCORE COUNTER FUNCTION HERE }'

//     let scoreCounter = () => {
//         playerScore++;
//         scoreBox.innerHTML = "Your Score: " + playerScore;

//     }

//     let playerScore = 0;
//     interval = this.setInterval(scoreCounter, 200);

// This methord will increase the score every 200 millisecond. And this will only start working if we press spacebar.
